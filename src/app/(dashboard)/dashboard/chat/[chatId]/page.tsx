...
async function getChatMessages(chatId: string) {
  try {
    ...
    const dbMessages = results.map((messages) => JSON.parse(messages) as Message)
...
const Page = async ({ params }: PageProps) => {
  ...
  return <div className='flex-1 justify-between flex flex-col h-full max-g-[calc(100vh-6rem)]'>
